...
// Constants - Messages
const MESSAGES = {
    FISH: 'FISH!! I am speed!!',
    CHOCOLATE: 'Berk chocolate !! I\'m sick!!',
    CUCUMBER: 'OMG a Cucumber!! I\'m afraid!!',
    BIRD: 'BIRD!! I\'m flying!!',
    EMPTY: '',
...
export default class Main extends Scene {
    ...
    registerAudios() {
        ...
        this.audios.music.default = this.sound.add('music:default', { volume: AUDIO_VOLUME.MUSIC_DEFAULT, loop: true }).play();
    }
